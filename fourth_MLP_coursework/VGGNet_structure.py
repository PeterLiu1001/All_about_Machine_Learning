...
'''
The structure for VGGNet is similar with this one with some little tune.
Change teh data provider for loading our data.
...
'''Close the sess and when all the episode have been run'''
